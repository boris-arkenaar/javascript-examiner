...
\begin{description}
  ...
  \item[tutor] The person that aims to support the {\em student} in learning
    JavaScript.
  \item[student] A person that is enrolled to course {\em Webapplications: 
    the Client Side}
  \item[user] A person that visits an online learning platform.
  \item[Webapplications: the Client Side] A course offered by the Open University
