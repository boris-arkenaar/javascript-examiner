...
\begin{itemize}
  ...
  \item Designing a prototype
  \item Building a prototype
...
\begin{itemize}
  ...
  \item There is no computer to build a prototype
  \item There is no platform to implement the prototype
  \item There is not enough time to build a prototype
...
\begin{itemize}
  ...
  \item Borrow one, use a friends one, ask the projectowner
