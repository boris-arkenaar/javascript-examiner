...
% Indien er tijd zit tussen de afronding van het projectplan en de start van
% het project, wat wordt er in de tussentijd gedaan?
...
%TODO: Based on Webapplicaties Clientkant
...
% Welke zijn het belangrijkste en hebben de hoogste prioriteit, en welke een
% lagere?
...
% Welke formele communicatie is van belang voor het slagen van het project,
% zowel intern als extern?

%@Bram TODO: naar 5.5 (Externe communicatie), 5.7 (Interne communicatie) 
...
\subsection{Activities} 	%TODO: @Bram Focuss areas syncen + Bijeenkomst Eindhoven
...
%@Bram: TODO: Richtlijnen om (afgeronde producten) te bespreken. Precieze tijdstip in onderling overleg.
