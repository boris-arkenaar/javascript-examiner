...
% Vanaf 'BDD comes in two flavors' tot het einde van de paragraaf loopt het
% niet echt lekker; ik kan je niet goed volgen
...
% Onderstaande zin loopt niet lekker, twee keer 'can'
