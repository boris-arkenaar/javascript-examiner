...
context section places the product in perspective. Related studies and efforts have been analyzed. A closely related and matured academic project has been analyzed more closely through a consult with one the main stakeholders.

% -       research/domain-research-introduction
% -       research/domain-research
% -    Research Context}
% -       research/research-context
The researches resulted into a set of requirements, which enabled the transition
from research to the actual implementation. These extracted requirement have
...
containing the relation between domain, checks, RESTful server and frontend.
...
It handles about the UI framework Polymer (with a part about Web components and
...
% TODO: dit meer aankleden of helemaal weglaten

% % an introduction of the team
% \section{Team}
% % Procesverslag
% At the beginning, a face-to-face meeting had already been planned, to work out 
% the initial ideas we had. A positive coincidence was that we are geographically 
% not far apart.
