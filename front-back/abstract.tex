...
feedback on JavaScript code written by students. On top of these merely pragmatic 
goals, the inquiry toward didactics in educating computer science is an 
...
developed. This application has become an easily extensible, modular tool 
...
As both the architecture of the application as the scope of the research 
largely orientated beyond the scope of this project, within this thesis there 
are uttered many ideas for expansion, and no constraints to expand or deploy the
